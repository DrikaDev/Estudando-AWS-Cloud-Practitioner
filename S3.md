...
O **Amazon S3** oferece uma infraestrutura de armazenamento resiliente, e o **versionamento** adiciona um nível extra de proteção.  

Quando habilitado, o versionamento permite recuperar arquivos que foram **deletados por engano**.  
O versionamento mantém diversas variantes de um objeto no mesmo bucket.  

<img width="581" height="257" alt="image" src="https://github.com/user-attachments/assets/4da50926-4176-487c-85e5-447046417d86" />

Isso significa que ele pode ser usado para **preservar, recuperar e restaurar** todas as versões de cada objeto no bucket do S3.  
Dessa forma, é possível **recuperar facilmente dados** em casos de ações não intencionais de usuários ou falhas na aplicação.  

---

**Ativando o versionamento:**  

<img width="1393" height="174" alt="image" src="https://github.com/user-attachments/assets/169417c4-5e39-48ac-8972-9f4aa302d102" />

Uma vez que o versionamento está habilitado, é possível visualizar o botão **"Mostrar versões"**:  

<img width="693" height="219" alt="image" src="https://github.com/user-attachments/assets/7c663efc-066f-4e15-b001-31515bddf025" />
